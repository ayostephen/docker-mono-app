locals {
  user_data = <<-EOF
    ...
    sudo cp /tmp/${var.private-key-name} /home/ec2-user/.ssh/
    sudo chmod 400 /home/ec2-user/.ssh/${var.private-key-name}
    sudo chown ec2-user:ec2-user /home/ec2-user/.ssh/${var.private-key-name}
